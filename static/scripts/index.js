document.addEventListener("DOMContentLoaded", function() {
    ...
    // Save selected apps and update the count
    saveAppsButton.onclick = function() {
        var selectedApps = document.querySelectorAll('input[name="apps"]:checked');
        var n = selectedApps.length; // Get the number of selected apps
        document.getElementById('n').value = n;  // Update hidden input with the count
